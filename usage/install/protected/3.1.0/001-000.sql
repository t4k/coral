...
INSERT INTO Layout (layoutCode, name, resourceType) VALUES ("TR_B1_R5", "Book Requests (Excluding OA_Gold) (TR_B1) R5", "Title");
INSERT INTO Layout (layoutCode, name, resourceType) VALUES ("TR_B2_R5", "Book Access Denied (TR_B2) R5", "Title");
INSERT INTO Layout (layoutCode, name, resourceType) VALUES ("TR_B3_R5", "Book Usage by Access Type (TR_B3) R5", "Title");
INSERT INTO Layout (layoutCode, name, resourceType) VALUES ("TR_J1_R5", "Journal Requests (Excluding OA_Gold) (TR_J1) R5", "Title");
INSERT INTO Layout (layoutCode, name, resourceType) VALUES ("TR_J2_R5", "Journal Access Denied (TR_J2) R5", "Title");
INSERT INTO Layout (layoutCode, name, resourceType) VALUES ("TR_J3_R5", "Journal Usage by Access Type (TR_J3) R5", "Title");
INSERT INTO Layout (layoutCode, name, resourceType) VALUES ("TR_J4_R5", "Journal Requests by YOP (Excluding OA_Gold) (TR_J4) R5", "Title");
...
ALTER TABLE SushiService ADD COLUMN requestorKey VARCHAR(255);
